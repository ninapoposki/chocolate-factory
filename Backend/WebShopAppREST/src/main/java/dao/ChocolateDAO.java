...
public class ChocolateDAO {
    private HashMap<String, Chocolate> chocolates = new HashMap<>();
    ...
    public void loadChocolates(String contextPath) {
        if (factoryDAO == null) {
            throw new IllegalStateException("FactoryDAO is not initialized");
        }
        ...
        try {
            ...
            while ((line = in.readLine()) != null) {
                ...
                chocolates.put(chocolate.getId(), chocolate);
                System.out.println("Chocolate loaded: " + chocolate.getChocolateName() + ", Factory: " + factory.getFactoryName());
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
